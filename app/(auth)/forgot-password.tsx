...
import { sendPasswordRecoveryOtp } from '@/features/auth/api';
  ...
  async function onSubmit() {
    ...
    try {
      ...
      router.push({
        ...
        params: { email: parsed.data.email, mode: 'recovery' },
      });
    } catch {
      setSubmitError('Could not send a reset code. Check your email and try again.');
    } finally {
      setSubmitting(false);
    }
  }
        ...
        <ScrollView
          ...
          <View style={[styles.content, screenBodyPadding]}>
            <View style={styles.header}>
              <Text style={[typography.h1, { color: c.text }]}>Forgot password?</Text>
            ...
            <View style={styles.form} onLayout={onFormLayout}>
              ...
              <Button label="Send reset code" onPress={onSubmit} loading={submitting} />
            </View>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
